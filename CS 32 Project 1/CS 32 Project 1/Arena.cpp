...
: m_PreviousClass(nRows, nCols) //initizaling list; need this to initialize previous class since there is an object instance of previous class in arena
{
...
Previous& Arena:: thePrevious(){
    return m_PreviousClass; //returns previous class object
}
