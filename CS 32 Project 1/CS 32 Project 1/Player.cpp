...
{
    m_age++;
    m_arena -> thePrevious().dropACrumb(m_row, m_col);//we have a pointer to arena object instance and the thePrevious() returns an object instance of class Previous; That is why we are able to call dropACrumb
}
