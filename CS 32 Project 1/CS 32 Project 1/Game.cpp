...
void Game::play()
{
    ...
    do
    {
        ...
        else
        {
            ...
            break;
            case 'p':{
                m_arena -> thePrevious().showPreviousMoves(); //arena class pointing to a function that returns grid from previous class and also erases the grid from arena
                cout << "Press Enter to continue" << endl;
                cin.ignore(10000,'\n');
                continue; // move onto the next case if the player presses something else
            }
            case 's':
